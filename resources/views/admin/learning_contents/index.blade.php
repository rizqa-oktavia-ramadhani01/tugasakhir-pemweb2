...
<head>
    ...
    <title>Data Learning Content - Admin TUTURO</title>
    ...
    <div class="min-h-screen flex">
        ...
        <main class="flex-1 p-6">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold">Data Learning Content</h1>
                <a href="{{ route('admin.learning-contents.create') }}" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 font-medium">{{ $content->judul }}</td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('admin.learning-contents.show', $content->id) }}" class="text-blue-600 hover:text-blue-800 mr-3">
                                    <i class="fa-solid fa-eye"></i> Detail
                                </a>
                                <a href="{{ route('admin.learning-contents.edit', $content->id) }}" class="text-yellow-600 hover:text-yellow-800 mr-3">
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                ...
                                Belum ada data learning content.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
