...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/setting/reset-data', [SettingController::class, 'resetData'])
        ->name('setting.reset-data');
});
...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::get('/activities/create', [AdminActivityController::class, 'create'])
        ->name('admin.activities.create');

    Route::post('/activities', [AdminActivityController::class, 'store'])
        ->name('admin.activities.store');

    Route::get('/activities/{id}/show', [AdminActivityController::class, 'show'])
        ->name('admin.activities.show');

    Route::get('/activities/{id}/edit', [AdminActivityController::class, 'edit'])
    ...
    Route::get('/learning-contents', [AdminLearningContentController::class, 'index'])
        ->name('admin.learning-contents.index');

    Route::get('/learning-contents/create', [AdminLearningContentController::class, 'create'])
        ->name('admin.learning-contents.create');

    Route::post('/learning-contents', [AdminLearningContentController::class, 'store'])
        ->name('admin.learning-contents.store');

    Route::get('/learning-contents/{id}/show', [AdminLearningContentController::class, 'show'])
        ->name('admin.learning-contents.show');

    Route::get('/learning-contents/{id}/edit', [AdminLearningContentController::class, 'edit'])
        ->name('admin.learning-contents.edit');

    Route::put('/learning-contents/{id}', [AdminLearningContentController::class, 'update'])
        ->name('admin.learning-contents.update');

    Route::delete('/learning-contents/{id}', [AdminLearningContentController::class, 'destroy'])
        ->name('admin.learning-contents.destroy');
});